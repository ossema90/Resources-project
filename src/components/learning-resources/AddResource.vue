...
export default {
    ...
    methods: {
        submitData() {
            ...
            const entredDescription = this.$refs.descInput.value;
            const enteredUrl = this.$refs.linkInput.value;
            if (entredTitle.trim() === '' || entredDescription.trim() === '' || enteredUrl.trim() === '') {
                this.inputIsInvalid = true;
                return;
            }
            this.addResource(entredTitle, entredDescription, enteredUrl);
        },
        confirmError() {
